...
const generateDescription = () => {
  const sentence = `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras aliquet varius magna, non porta ligula feugiat
...
const event = {
  ...
  offers: shuffleArray(generateOffers().slice()),
